...
namespace knowledgeBaseUI
{
    ...
    {
        private readonly  IDataConnection _dataConnection = new XmlConnector(@"C:\Users\rivaa\source\repos\cSharpLearning\knowledgeBaseApp\knowledgeBaseLibrary\Data\PostRepository.xml");
        public Search()
        {
            InitializeComponent();
