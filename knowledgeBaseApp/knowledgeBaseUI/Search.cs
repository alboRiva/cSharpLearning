...
namespace knowledgeBaseUI
{
    ...
    {
        private readonly  IDataConnection _dataConnection = new XmlConnector(@"C:\Users\rivaa\OneDrive\Desktop\knowledgeBaseApp\knowledgeBaseLibrary\Data\PostRepository.xml");
        public Search()
        {
            InitializeComponent();
            ...
            xmlDataSet.ReadXml(@"C:\Users\rivaa\OneDrive\Desktop\knowledgeBaseApp\knowledgeBaseLibrary\Data\PostRepository.xml");
            // This line of code is generated by Data Source Configuration Wizard
        ...
        /// TODO: change DataBinding implemetation in order to speed up refresh
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void SearchListControl_MouseHover(object sender, EventArgs e)
        {
            System.Data.DataSet xmlDataSet = new System.Data.DataSet("XML DataSet");
            // Load the XML document to the DataSet
            xmlDataSet.ReadXml(@"C:\Users\rivaa\OneDrive\Desktop\knowledgeBaseApp\knowledgeBaseLibrary\Data\PostRepository.xml");
